...
```{r}
blue_title <- theme(
    plot.title = element_text(size = 20, color = "steelblue", face = "italic", hjust = 0.5)) 
...
ggplot(mpg, aes(x=displ, y=hwy)) +
  ...
  theme_solarized() +
  theme(
    plot.title = element_text(size = 18, color = "steelblue", face = "bold", hjust = 0.5),
    axis.title = element_text(family = "Courier New", size = 14, color = "navyblue"),
    axis.text = element_text(family = "Courier New", size = 12, color = "navy"),
