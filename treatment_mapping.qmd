...
1.  How does the **percentage of treatments being [completed]{.underline}** & **percentage of treatments ending with no use [vary by the service]{.underline}** (completed_cases) and [**length of stay**]{.underline}. (services_d) Create at least 3 visualizations to try and answer this question
