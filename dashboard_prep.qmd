...
```{r}
studentdata <- read_csv(here("FALL 24/CS201/data/Scores.csv"))
...
1.  *RELATIONSHIP BETWEEN WEEKLY STUDY HOURS AND SUBJECT SCORES.*

2.  *WHAT PERCENTAGE OF STUDENTS FALL INTO DIFFERENT ETHNIC GROUPS, LUNCH TYPES, SPORTS, TRANSPORTATION MEANS.*

3.  *RELATIONSHIP BETWEEN PARENT'S EDUCATION AND SUBJECT SCORES.*
